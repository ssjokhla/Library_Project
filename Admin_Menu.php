...
$s = "select * from Admins where Username = '$Admin' and Password = '$admPass'";
...
<HTML>
    <BODY>  
		   		        <P> Which type of functionality do you want to perform from below list : </p>
						<input type = button value = Add_Documents onclick=window.location.href='Add_Documents.html' size = 40>  <br><br>
